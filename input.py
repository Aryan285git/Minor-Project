...
# Plot predicted values for Nifty and Sensex until the entered date
future_date_nifty = pd.to_datetime(input("Enter future date for Nifty prediction (YYYY-MM-DD): "))
plot_nifty_predictions(best_order_nifty[0], best_order_nifty[1], best_order_nifty[2], nifty_data, future_date_nifty)

future_date_sensex = pd.to_datetime(input("Enter future date for Sensex prediction (YYYY-MM-DD): "))
